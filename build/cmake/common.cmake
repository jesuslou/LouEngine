...
function(add_framework_files header_files source_files)
	...
	elseif(USE_SDL2)
		file(GLOB_RECURSE extra_headers "${CMAKE_CURRENT_SOURCE_DIR}/frameworks/SDL2/include/*.h")
		file(GLOB_RECURSE extra_sources "${CMAKE_CURRENT_SOURCE_DIR}/frameworks/SDL2/source/*.cpp")
	endif()
	if(extra_headers)
		set(header_files  "${header_files};${extra_headers}" CACHE INTERNAL "header_files")
	endif()
...
function(add_framework_include_directories lib_name)
	...
	elseif(USE_SDL2)
		target_include_directories ("${lib_name}" PUBLIC "${CMAKE_CURRENT_SOURCE_DIR}/frameworks/SDL2/include")
	endif()
