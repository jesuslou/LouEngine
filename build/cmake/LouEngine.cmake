...
function(link_sdl2_libraries target_name sdl2_libraries sdl2_folder)
	foreach(dependency ${sdl2_libraries})
		target_link_libraries("${target_name}" "${dependency}")
	endforeach()
	if ("SDL2-static" IN_LIST sdl2_libraries)
		target_include_directories("${target_name}" PUBLIC "${sdl2_folder}/SDL2/include")
	endif()
	if ("glm_static" IN_LIST sdl2_libraries)
		target_include_directories("${target_name}" PUBLIC "${sdl2_folder}/glm")
	endif()
	if ("SDL_image" IN_LIST sdl2_libraries)
		target_include_directories("${target_name}" PUBLIC "${sdl2_folder}/SDL_image")
	endif()
endfunction(link_sdl2_libraries)
